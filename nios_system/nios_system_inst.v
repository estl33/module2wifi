	nios_system u0 (
		.bass_out_export     (<connected-to-bass_out_export>),     //      bass_out.export
		...
		.treble_out_export   (<connected-to-treble_out_export>),   //    treble_out.export
		.volume_out_export   (<connected-to-volume_out_export>),   //    volume_out.export
		.wifi_uart_out_rxd   (<connected-to-wifi_uart_out_rxd>),   // wifi_uart_out.rxd
		.wifi_uart_out_txd   (<connected-to-wifi_uart_out_txd>),   //              .txd
		.pi_uart_out_rxd     (<connected-to-pi_uart_out_rxd>),     //   pi_uart_out.rxd
		.pi_uart_out_txd     (<connected-to-pi_uart_out_txd>)      //              .txd
	);
