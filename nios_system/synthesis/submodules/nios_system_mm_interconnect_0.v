...
module nios_system_mm_interconnect_0 (
	...
	wire  [106:0] sound_in_s1_agent_rf_source_data;                                                   // sound_in_s1_agent:rf_source_data -> sound_in_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] sound_in_s1_agent_rsp_fifo_out_data;                                                // sound_in_s1_agent_rsp_fifo:out_data -> sound_in_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> sound_in_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // sound_in_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [14:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> sound_in_s1_agent:cp_channel
	...
	wire  [106:0] sound_out_s1_agent_rf_source_data;                                                  // sound_out_s1_agent:rf_source_data -> sound_out_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] sound_out_s1_agent_rsp_fifo_out_data;                                               // sound_out_s1_agent_rsp_fifo:out_data -> sound_out_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> sound_out_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // sound_out_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [14:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> sound_out_s1_agent:cp_channel
	...
	wire  [105:0] sound_in_s1_agent_rp_data;                                                          // sound_in_s1_agent:rp_data -> router_015:sink_data
	...
	wire  [105:0] sound_out_s1_agent_rp_data;                                                         // sound_out_s1_agent:rp_data -> router_016:sink_data
